...
("preferred_tenant_type",PANEL,STAGE_2,(),(),"Exact sheet dropdown vocabulary is not verified in repository source; no values are invented here."),
("bachelor_preference",PANEL,STAGE_2,(),("preferred_tenant_type",),"Exact sheet dropdown vocabulary is not verified in repository source; family-only rule is deterministic."),
("pet_friendly",PANEL,STAGE_2,(),(),"Exact sheet dropdown vocabulary is not verified in repository source."),
