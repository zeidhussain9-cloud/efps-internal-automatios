...
("internal_property_type",PANEL,STAGE_2,("Gated Community","Semi Gated","Standalone"),(),"Direct source field preferred; otherwise deterministic gating-wording fallback."),
...
("society_amenities",PANEL,STAGE_2,("Security, Lift, CCTV, Power Backup","Club House, Lift, Gym, CCTV, Power Backup, Swimming Pool, Garden, Sports, Kids Area","-"),("internal_property_type",),"Exact live Sheet vocabulary; type-driven default is Gated→gated set, Semi Gated→semi set, Standalone→-."),
...
("property_highlights",PANEL,STAGE_2,(),(),"Explicit source highlights preserved; otherwise factual deterministic fragments only. Optional AI may wordsmith."),
("catalog_title",PANEL,STAGE_2,(),(),"Explicit title preserved; otherwise factual deterministic fallback. Optional AI may wordsmith."),
...
("age_of_property_years",PANEL,STAGE_2,(),(),"Explicit/authoritative source fact only; never inferred from Maps."),
