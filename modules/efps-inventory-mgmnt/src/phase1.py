...
def project(raw_text:str,row:dict[str,Any]|None=None)->dict[str,str]:
    ...
    if resolved_subtype:base["property_subtype"]=resolved_subtype
    elif has_property_subtype_evidence(raw_text):base["property_subtype"]=""
    ...
    for reserved in schema.RESERVED_COLUMNS:base[reserved]=""
    return base
