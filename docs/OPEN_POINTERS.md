...
- Exact Google Sheets inventory schema for the new architecture must be established from the current owner-approved source before implementation.
- Exact WhAPI production connection/resource identifiers must be verified before live integration work.
