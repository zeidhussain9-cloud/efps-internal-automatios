...
`docs/` is the single canonical home for EFPS business and system knowledge.

## Documents

- `BUSINESS_CONTEXT.md` — EFPS business rules, terminology, and business principles.
- `PROJECT_RULES.md` — standing engineering and automation rules.
- `ARCHITECTURE.md` — repository-wide architecture and ownership boundaries.
